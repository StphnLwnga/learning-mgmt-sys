 ...
 */
const ChapterTitleForm = ({ initialData, courseId }: ChapterTitleFormProps): JSX.Element => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>): Promise<void> => {
    try {
      const { data: { title } } = await axios.patch(`/api/courses/${courseId}/chapters/${initialData?.id}`, data);
      toast({
        title: 'Success',
